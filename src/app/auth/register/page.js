                    ...
                    <CardContent>
                        <Box
                            ...
                            <Box
                                ...
                                <Typography color='text.tertiary' sx={{ fontSize: '14px' }}>
                                    Nobero wants to make sure that it&apos;s really you. Nobero will send an email with a six-digit confirmation code
                                    on your
                                </Typography>
                            </Box>
                            <form onSubmit={handleSubmit(onSubmit)}>
                                <TextField
                                    ...
                                    helperText={errors.confirmationCode ? 'Code is required' : ''}
                                />
                                <Button
                                    type='submit'
                                    fullWidth
...
const RegisterFlow = () => {
    ...
    return (
        <>
            {step === 1 && <Register onStepChange={handleStepChange} />}
            {step === 2 && <EmailConfirmation formData={formData} onEmailConfirmed={handleEmailConfirmed} setStep={setStep} />}
        </>
    );
};
